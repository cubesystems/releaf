jQuery(function()
{
	...
	jQuery( document ).on( 'scrollinit', '.leaf_table[data-continuous="1"]', function()
	{
						...
						if( pages[ i ] === undefined )
						{
							(function(){
								...
								({
									...
									{
										delete requests[key];
										pages[ pageNo ] = jQuery( html ).find( '.leaf_table .tbody' ).html();
										inject();
									}
								});	
							})();
	...
	jQuery( '.leaf_table[data-continuous="1"]' ).trigger( 'scrollinit' );
});