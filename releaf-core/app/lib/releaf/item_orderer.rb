module Releaf
  ...
  class ItemOrderer
    ...
    #
    #    Releaf::ItemOrderer.reorder([:a, :b, :c, :d, :e, :f], c: :last, [:a, :b] => {after: :d})
    # is same as
    #    Releaf::ItemOrderer.new(:a, :b, :c, :d, :e, :f).reorder(:c, :last).reorder([:a, :b], after: :d).result
    #
