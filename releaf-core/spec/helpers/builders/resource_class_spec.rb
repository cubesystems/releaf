...
describe Releaf::Builders::ResourceClass, type: :module do
  class ResourceClassTestHelper < ActionView::Base; end
  class ResourceClassIncluder
    include Releaf::Builders::ResourceClass
    attr_accessor :template
  end

  let(:subject){ ResourceClassIncluder.new }
  let(:template){ ResourceClassTestHelper.new }
